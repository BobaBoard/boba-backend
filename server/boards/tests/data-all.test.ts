...
const extractBoardUpdates = (boardData: any) => {
  return {
    ...
    last_comment_at: boardData.last_comment_at,
    last_post_at: boardData.last_post_at,
    last_visit_at: boardData.last_visit_at,
    last_activity_at: boardData.last_activity_at,
    last_activity_from_others_at: boardData.last_activity_from_others_at,
  };
};
    ...
    test("fetches all boards updates (with user)", async () => {
      ...
      expect(boards.map(extractBoardUpdates)).toEqual([
        ...
        },
        {
          ...
          realm_external_id: TWISTED_MINDS_REALM_EXTERNAL_ID,
          has_updates: true,
          last_comment_at: new Date(Date.UTC(2020, 9, 4, 12, 44)),
          last_post_at: new Date(Date.UTC(2020, 8, 25, 12, 42)),
          last_activity_at: new Date(Date.UTC(2020, 9, 4, 12, 44)),
          // Note: this will NOT be the same as last_comment, since that is from Bobatan
          last_activity_from_others_at: new Date(Date.UTC(2020, 9, 2, 12, 43)),
          last_visit_at: new Date(Date.UTC(2020, 4, 25, 16, 42)),
        },
        {
          slug: "anime",
          external_id: "4b30fb7c-2aca-4333-aa56-ae8623a92b65",
          realm_external_id: TWISTED_MINDS_REALM_EXTERNAL_ID,
          has_updates: true,
          last_comment_at: new Date(Date.UTC(2020, 3, 24, 12, 44)),
          last_post_at: new Date(Date.UTC(2020, 3, 24, 12, 42)),
          last_activity_at: new Date(Date.UTC(2020, 3, 24, 12, 44)),
          last_activity_from_others_at: new Date(Date.UTC(2020, 3, 24, 12, 44)),
          last_visit_at: new Date(Date.UTC(2022, 4, 10, 16, 42)),
        },
        {
          slug: "long",
          external_id: "db8dc5b3-5b4a-4bfe-a303-e176c9b00b83",
          realm_external_id: TWISTED_MINDS_REALM_EXTERNAL_ID,
          has_updates: true,
          last_comment_at: new Date(Date.UTC(2020, 3, 1, 12, 22)),
          last_post_at: new Date(Date.UTC(2020, 3, 25, 12, 42)),
          last_activity_at: new Date(Date.UTC(2020, 3, 25, 12, 42)),
          last_activity_from_others_at: new Date(Date.UTC(2020, 3, 25, 12, 42)),
          last_visit_at: null,
        },
        {
          slug: "memes",
          ...
          has_updates: false,
          last_comment_at: null,
          last_post_at: new Date(Date.UTC(2020, 7, 22, 10, 36, 55, 850)),
          last_activity_at: new Date(Date.UTC(2020, 7, 22, 10, 36, 55, 850)),
          last_activity_from_others_at: null,
          last_visit_at: null,
        },
        {
        ...
        },
        {
          ...
          has_updates: false,
          last_comment_at: null,
          last_post_at: new Date(Date.UTC(2022, 9, 24, 15, 40)),
          last_activity_at: new Date(Date.UTC(2022, 9, 24, 15, 40)),
          last_activity_from_others_at: null,
          last_visit_at: null,
        },
        {
    ...
    test("fetches all boards updates (no user)", async () => {
      ...
      expect(boards.map(extractBoardUpdates)).toEqual([
        ...
        },
        {
          ...
          has_updates: false,
          last_comment_at: null,
          last_post_at: new Date(Date.UTC(2020, 0, 14, 8, 42)),
          last_activity_at: new Date(Date.UTC(2020, 0, 14, 8, 42)),
          last_activity_from_others_at: null,
          last_visit_at: null,
        },
        {
    ...
    test("fetches all boards updates (dismissed notifications)", async () => {
      ...
      expect(boards.map(extractBoardUpdates)).toEqual([
        ...
        },
        {
          ...
          last_activity_at: new Date(Date.UTC(2020, 9, 4, 12, 44)),
          last_activity_from_others_at: new Date(Date.UTC(2020, 9, 4, 12, 44)),
          last_visit_at: null,
        },
        {
          slug: "anime",
          ...
          last_activity_at: new Date(Date.UTC(2020, 3, 24, 12, 44)),
          last_activity_from_others_at: null,
          last_visit_at: new Date(Date.UTC(2020, 3, 26, 7, 0)),
        },
        {
          slug: "long",
          external_id: "db8dc5b3-5b4a-4bfe-a303-e176c9b00b83",
          ...
          last_activity_at: new Date(Date.UTC(2020, 3, 25, 12, 42)),
          last_activity_from_others_at: new Date(Date.UTC(2020, 3, 25, 12, 42)),
          last_visit_at: new Date(Date.UTC(2020, 3, 24, 7, 0)),
        },
        {
          slug: "memes",
          external_id: "0e0d1ee6-f996-4415-89c1-c9dc1fe991dc",
          ...
          last_post_at: new Date(Date.UTC(2020, 7, 22, 10, 36, 55, 850)),
          last_activity_at: new Date(Date.UTC(2020, 7, 22, 10, 36, 55, 850)),
          last_activity_from_others_at: new Date(
        ...
        },
        {
          ...
          last_post_at: new Date(Date.UTC(2022, 9, 24, 15, 40)),
          last_activity_at: new Date(Date.UTC(2022, 9, 24, 15, 40)),
          last_activity_from_others_at: new Date(Date.UTC(2022, 9, 24, 15, 40)),
          last_visit_at: null,
        },
        {
          slug: "restricted",
