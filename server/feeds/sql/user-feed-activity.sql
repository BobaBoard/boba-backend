...
SELECT
    ...
    -- Amount details
    COALESCE(posts_amount, 0)::integer as thread_total_posts_amount,
    COALESCE(threads_amount, 0)::integer as thread_direct_threads_amount,
    COALESCE(comments_amount, 0)::integer as thread_total_comments_amount,
    COALESCE(new_posts_board_amount, 0)::integer as thread_new_posts_amount,
    COALESCE(new_comments_board_amount, 0)::integer as thread_new_comments_amount,
